 ...
 * This is a development-specific feature and relies on a custom fetch endpoint.
 */
const openReadmeInEditor = () => fetch("/__open-in-editor?file=README.md");
</script>

<template>
  <!-- This component displays a welcome message with links to documentation, tooling, ecosystem, community, and support. -->
  <WelcomeItem>
    <template #icon>
      <DocumentationIcon />
    </template>
